...
export default function NewAudioPlayer({ currentIndex, setCurrentIndex, total }) {
  ...
  useEffect(() => {
    const setAudioSource = () => {
      ...
      } else if (currentSong?.lyricApiUrl) {
        
        audioRef.current.src = currentSong.lyricApiUrl;
      ...
      if (!audioRef.current.src) {
        console.error("No valid audio source found for the current track.");
      }
    };
